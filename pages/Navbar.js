                ...
                <nav>
                    ...
                    <div className={Hamshow ? "hammenu-mobile" : "hammenu"}>
                        <div className="first">
                            ...
                            {isAuthenticated ? (  <div className="log"><Link className='otherLink' to="/logout">
                                <span className="material-symbols-outlined">contacts_product</span><p className={Hamshow ? "hammenu" : "hammenu-mobile"}>Logout</p></Link></div>):(
                                 <div className="log"><Link className='otherLink' to="/login">
                                <span className="material-symbols-outlined">contacts_product</span><p className={Hamshow ? "hammenu" : "hammenu-mobile"}>Login</p></Link></div>
                                )}
                        </div>
                    ...
                    <ul className='one'>
                        ...
                        <div className="order">
                            ...
                            <li><NavLink className='otherLink' to="/contact"><span className="material-symbols-outlined">call</span>Contact-us</NavLink></li>
                            {isAuthenticated ? (
                                <li>
                                    <NavLink className='otherLink' to="/logout">
                                        <span className="material-symbols-outlined">contacts_product</span>Logout
                                    </NavLink>
                                </li>
                            ) : (
                                <li>
                                    <NavLink className='otherLink' to="/login">
                                        <span className="material-symbols-outlined">contacts_product</span>Login
                                    </NavLink>
                                </li>
                            )}
